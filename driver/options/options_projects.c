 ...
 *i_opt=*i_opt+1;
 ...
 options[*i_opt].bin="yambo_sc yambo_magnetic yambo_rt yambo_electric yambo_models";
 ...
 *i_opt=*i_opt+1;
 ...
 options[*i_opt].bin="yambo_rt yambo_sc yambo_electric yambo_magnetic yambo_models";
