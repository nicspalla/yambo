...
MOD_PROJ = yambo_models ypp_models
MAIN     = $(CORE) $(PH_PROJ) $(SC_PROJ) $(RT_PROJ)  $(NL_PROJ) $(MOD_PROJ) 
ALL      = $(CORE) $(PH_PROJ) $(SC_PROJ) $(RTE_PROJ) $(NL_PROJ) $(MOD_PROJ) $(GPL)
BROKEN   = yambo_phdyn
SCRIPTS  = ydb.pl
EXE      = $(CORE) $(PH_PROJ) $(SC_PROJ) $(RTE_PROJ) $(NL_PROJ) $(MOD_PROJ) $(BROKEN) $(SCRIPTS)
